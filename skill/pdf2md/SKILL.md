...
Read `document.md`. Rewrite **in place** so it reads like real notes, not raw slide OCR. Rules and examples: [references/format-full.md](references/format-full.md). Stitch split code blocks (e.g., try-catch-finally statements) and continuous sentences back together across page boundaries.
